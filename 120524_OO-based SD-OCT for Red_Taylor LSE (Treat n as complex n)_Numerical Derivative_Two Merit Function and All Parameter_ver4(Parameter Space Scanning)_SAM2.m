...
Ratio_Reference2Sample=1.3;
Ratio_Upper2Lower=1.5+[-0.3:0.1:0.3];
Number_of_Loop=100;
Thickness=([-0.1:0.01:0.1]+2.58).*1E-6;% ([-0.1:0.1:0.1]+2.55).*1E-6;
Load_Previous_Result=0;
Position_Upper_Interface=(15.3).*1E-6;  %([-1:0.02:1]+10.82)*1E-6;%[0.019:0.001:0.024]*1E-6;%[0.02:0.0003:0.023]*1E-6;
%%
n_should=1.7;
delta_n=0.4;
...
Filter_inter=0;
cd('D:\120523\Dispersion Compensated\SAM2_OPD3FOC1\inter\');
for j=0:99
...
Filter_sam=0;
cd('D:\120523\Dispersion Compensated\SAM2_OPD3FOC1\sam\');
for j=0:99
...
Filter_ref=0;
cd('D:\120523\Dispersion Compensated\SAM2_OPD3FOC1\ref\');
for j=0:99
