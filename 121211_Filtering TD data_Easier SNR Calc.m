...
TH_first_peak=0.1;
TH_second_peak=0.01;
Delay_first_peak=200000; %the smaller one, pixel
Min_thickness=50000; %pixel

Max_thickness=90000; %pixel

cd('D:\Users\TuanShu\121211\MAX5V_Ref center\');
%cd('D:\Users\TuanShu\121211\MAX10V\');
...
Window1=(gaussmf(Frequency,[0.1E14 2E14]));
Window1(Frequency>1.5E14)=1;
Window2=(gaussmf(Frequency,[0.1E14 4E14]));
...
ind=[77];
thickness_array_even(ind)=[];


ind=[50];
thickness_array_odd(ind)=[];
