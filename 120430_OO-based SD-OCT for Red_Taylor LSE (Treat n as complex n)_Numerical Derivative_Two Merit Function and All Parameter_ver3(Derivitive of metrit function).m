...
if index_calculation==1   
            ...
            dRatio_Reference2Sample=1E-1;
            dRatio_Upper2Lower=1E-1;            
            while (Current_Loop<Number_of_Loop)
                ...
                %Thickness=Thickness+0.001*mean((T_Considered-T_abs(n,Thickness,Position_Upper_Interface,Ratio_Reference2Sample,Ratio_Upper2Lower))./((T_abs(n,Thickness+dThickness,Position_Upper_Interface,Ratio_Reference2Sample,Ratio_Upper2Lower)-T_abs(n,Thickness,Position_Upper_Interface,Ratio_Reference2Sample,Ratio_Upper2Lower))/dThickness));
                %Position_Upper_Interface=Position_Upper_Interface+0.1*mean((T_Considered-T_abs(n,Thickness,Position_Upper_Interface,Ratio_Reference2Sample,Ratio_Upper2Lower))./((T_abs(n,Thickness,Position_Upper_Interface+dPosition_Upper_Interface,Ratio_Reference2Sample,Ratio_Upper2Lower)-T_abs(n,Thickness,Position_Upper_Interface,Ratio_Reference2Sample,Ratio_Upper2Lower))/dPosition_Upper_Interface));
                Ratio_Reference2Sample=Ratio_Reference2Sample+0.0000001*min((T_Considered-T_abs(n,Thickness,Position_Upper_Interface,Ratio_Reference2Sample,Ratio_Upper2Lower))./((T_abs(n,Thickness,Position_Upper_Interface,Ratio_Reference2Sample+dRatio_Reference2Sample,Ratio_Upper2Lower)-T_abs(n,Thickness,Position_Upper_Interface,Ratio_Reference2Sample,Ratio_Upper2Lower))/dRatio_Reference2Sample));
                %Ratio_Upper2Lower=Ratio_Upper2Lower+0.1*mean((T_Considered-T_abs(n,Thickness,Position_Upper_Interface,Ratio_Reference2Sample,Ratio_Upper2Lower))./((T_abs(n,Thickness,Position_Upper_Interface,Ratio_Reference2Sample,Ratio_Upper2Lower+dRatio_Upper2Lower)-T_abs(n,Thickness,Position_Upper_Interface,Ratio_Reference2Sample,Ratio_Upper2Lower))/dRatio_Upper2Lower));
                n(isnan(n))=1.6;
                if isnan(Thickness)
                    Thickness=2.5E-6;
                elseif isnan(Position_Upper_Interface)
                    Position_Upper_Interface=10E-6;
