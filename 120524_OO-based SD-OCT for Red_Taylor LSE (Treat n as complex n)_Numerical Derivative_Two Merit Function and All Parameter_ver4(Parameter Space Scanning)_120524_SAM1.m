...
Ratio_Reference2Sample=[-0.1:0.02:0.1]+1;
Ratio_Upper2Lower=[-0.1:0.02:0.1]+0.7;
Number_of_Loop=100;
Thickness=([-0.05:0.01:0.05]+2.51).*1E-6;% ([-0.1:0.1:0.1]+2.55).*1E-6;
Load_Previous_Result=0;
Position_Upper_Interface=(17.66).*1E-6;  %([-1:0.02:1]+10.82)*1E-6;%[0.019:0.001:0.024]*1E-6;%[0.02:0.0003:0.023]*1E-6;
%%
n_should=1.7;
delta_n=0.4;
...
Filter_inter=0;
cd('D:\120524\SAM1_OPD1FOC1\inter\');
for j=0:99
