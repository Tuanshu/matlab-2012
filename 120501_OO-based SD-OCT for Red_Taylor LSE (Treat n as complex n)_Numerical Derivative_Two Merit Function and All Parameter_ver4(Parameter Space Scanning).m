...
Ratio_Reference2Sample=[-0.4:0.04:0]+1.43;
Ratio_Upper2Lower=[-0.3:0.03:0]+1.38;
Number_of_Loop=100;
Thickness=([0:0.03:0.3]+2.35).*1E-6;% ([-0.1:0.1:0.1]+2.55).*1E-6;
Load_Previous_Result=0;
Position_Upper_Interface=([-0.4:0.08:0.4]+11).*1E-6;  %([-1:0.02:1]+10.82)*1E-6;%[0.019:0.001:0.024]*1E-6;%[0.02:0.0003:0.023]*1E-6;
%%
n_should=1.7;
delta_n=0.4;
