...
cd('D:\120213\5-1\');
Data_1=importdata(sprintf('D%i.txt',50));       % Data_1: the color filter data

Data_2=importdata(sprintf('D%i.txt',950));      % Data_2: the glass data 1
Data_3=importdata(sprintf('D%i.txt',950));      % Data_3: the 

cd('D:\120213\5-R1\');
Data_4=importdata(sprintf('D%i.txt',50));       % Data_4: the calibration data for Data_1

Data_5=importdata(sprintf('D%i.txt',950));      % Data_5: the calibration data for Data_2
Data_6=importdata(sprintf('D%i.txt',950));      % Data_6: the calibration data for Data_3
...
for j=lateral_index_reference_start:lateral_index_reference_end

    Data_Reference=importdata(sprintf('D%i.txt',950));      % Data_2: the glass data 1
