...
Position_Error=(-0.7)*1E-6;%[0.019:0.001:0.024]*1E-6;%[0.02:0.0003:0.023]*1E-6;
%%
n_should=1.5;
delta_n=0.2;
...
plot(Wavelength_micron(Frequency_Considered_Min_Index:Frequency_Considered_Max_Index),n_final(Frequency_Considered_Min_Index:Frequency_Considered_Max_Index,3));

xlabel('Wavelength (micron)');
ylabel('n');

%%
plot(Wavelength_micron(Frequency_Considered_Min_Index:Frequency_Considered_Max_Index),k_final(Frequency_Considered_Min_Index:Frequency_Considered_Max_Index,2));

xlabel('Wavelength (micron)');
ylabel('k');
%%
plot(Wavelength_micron(Frequency_Considered_Min_Index:Frequency_Considered_Max_Index),T_abs_check(Frequency_Considered_Min_Index:Frequency_Considered_Max_Index,3));
