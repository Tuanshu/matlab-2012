...
k_final=interp1(data_k(:,1),data_k(:,2),Frequency);
k_final(isnan(k_final))=0;
...
dlmwrite('Wavelength_Spectroscopy.txt',Wavelength_Spectroscopy,'delimiter','\t','newline','pc');
dlmwrite('Spectroscopy_Old.txt',Spectroscopy_Old,'delimiter','\t','newline','pc');
