...
Spectrum_Ratio=Spectrum_Sample./Spectrum_Reference.*exp(i*4*pi.*Frequency/C*25E-6);

plot(Frequency,Spectrum_Ratio);

Spectrum_Ratio=Spectrum_Ratio./Gauss_Window;

Spatial_Range=20:0.1:40;
