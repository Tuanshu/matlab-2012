...
elseif strcmp(Scanning_1,'Ratio')
    Parameter_1=Ratio;
end
...
elseif strcmp(Scanning_2,'Ratio')
    Parameter_2=Ratio;
end
    ...
    for p=1:length(Parameter_1)
        for q=1:length(Parameter_2)
            ...
            while (Current_Loop<Number_of_Loop)
                ...
                delta_n = @ (n) (Aexp-((exp(i*4*pi.*Frequency_Considered/C.*(Position_Upper_Interface_Now))./r_BK7_Considered) .* ((n1_Considered-n)./(n1_Considered+n)...
                            ...
                            ./r_BK7_Considered) .* (-2*n1_Considered./(n1_Considered+n).^2 + (exp(i*4*pi.*Frequency_Considered/C.*n*Thickness_Now) ./ (1-((n-n1_Considered)./(n+n1_Considered))  ...
