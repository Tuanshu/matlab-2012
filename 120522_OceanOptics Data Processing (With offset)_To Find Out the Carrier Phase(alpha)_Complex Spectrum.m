...
while (Current_Iteration<Number_of_Iteration)
    ...
    Spectral_Array_delta_Amp=((Spectrum_New)-A(Amp,Thickness,Phi))./dA_dAmp(Amp,Thickness,Phi);
    Spectral_Array_delta_Thickness=((Spectrum_New)-A(Amp,Thickness,Phi))./dA_dThickness(Amp,Thickness,Phi);
    Spectral_Array_delta_Phi=((Spectrum_New)-A(Amp,Thickness,Phi))./dA_dPhi(Amp,Thickness,Phi);
