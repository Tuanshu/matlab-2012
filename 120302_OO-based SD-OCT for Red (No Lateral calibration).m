...
plot(Wavelength_micron(Wavelength_micron<0.65),Spectrum_Sample(Wavelength_micron<0.65),Wavelength_micron(Wavelength_micron<0.65),Spectrum_Reference(Wavelength_micron<0.65));
