...
imagesc(10*log10(Signal_Bscan_Envelope_Cut(350:1450,:)/max(max(Signal_Bscan_Envelope_Cut))),'xdata',(array*5)/1000,'ydata',Position_micron(350:1450)-Position_micron(350));
colormap(gray);
