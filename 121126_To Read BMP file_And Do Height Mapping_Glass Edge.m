...
fitting=0;
new_bit_depth=8;
cd('D:\Users\TuanShu\121126_Glass Edge\');
...
image_index=1:1900;
ROI=[150 600;200 800];      %up, down, left, right
...
for q=1:length(image_index)
    ...
    imwrite(Temp_Slides,sprintf('%i_New.png',image_index(q)),'Bitdepth',new_bit_depth);
    disp(q);
end
...
QQ=Image_Stack_New_Normalized(1555,:,507)';
