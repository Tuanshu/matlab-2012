...
Frequency_Considered=downsample(Frequency_Considered,10);
...
Aexp=downsample(Aexp,10);
Bexp=downsample(Bexp,10);
Cexp=downsample(Cexp,10);

T_Considered=T(Frequency_Considered_Min_Index:Frequency_Considered_Max_Index);
T_Considered=downsample(T_Considered,10);
...
Wavelength_micron_Considered=downsample(Wavelength_micron_Considered,10);
