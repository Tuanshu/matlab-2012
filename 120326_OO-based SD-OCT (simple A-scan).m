...
Data=importdata('120326_LARGE opd.txt');
%cd('D:\120222\');
...
Spectrum=Data(:,2);%-Data_R(:,2)-Data_S(:,2);
...
Profile(jj)=Position_micron(maxindex);
%% ROI
...
imagesc(10*log10(Signal_Bscan_Envelope),'ydata',Position_micron);
