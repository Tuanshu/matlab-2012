...
Ratio_Upper2Reference=1+[-0.6:0.005:0.6];
...
Ratio_Lower2Upper=1+[-0.6:0.005:0.6];  %([-1:0.02:1]+10.82)*1E-6;%[0.019:0.001:0.024]*1E-6;%[0.02:0.0003:0.023]*1E-6;
%%
n_should=1.7;
delta_n=0.2;
                ...
                for m=1:length(Position_Upper2Reference)
                    ...
                    while (Current_Loop<Number_of_Loop)
                        ...
                        if Merit < Merit_Best
                            ...
                            Thickness_std_Normalized=std(Thickness_Now)/mean(Thickness_Now);
