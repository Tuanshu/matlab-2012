...
Ratio_Upper2Reference=1.2+[-0.2:0.02:0.2];
Thickness=(4.4).*1E-6;% ([-0.1:0.1:0.1]+2.55).*1E-6; In this file, it is the initial guess of thickness
Ratio_Lower2Upper=1.2+[-0.2:0.02:0.2];%+[-0.2:0.02:0.2];  %([-1:0.02:1]+10.82)*1E-6;%[0.019:0.001:0.024]*1E-6;%[0.02:0.0003:0.023]*1E-6;
...
plot(Position_micron,Signal_Sample_First);
