...
cd('D:\120108_2_Ref\');
%Data=importdata('111010_Green (2500microsec) no word 5 ave 100.txt');
Ref=importdata(sprintf('D%i.txt',array(jj)-2054));
...
Signal_Ref_Bscan_Carrier(:,jj)=Signal_Ref_Carrier;
Signal_Ref_Bscan_Envelope(:,jj)=Signal_Ref_Envelope;
