...
cd('D:\Users\TuanShu\121016_Test1_Eye2\');
...
plot((1:(size(Image_Stack_New,1)))*Frame_Axial_Spacing,real(Image_Stack_New(:,round(150/Lateral_Spacing),round(200/Lateral_Spacing))));
xlabel('Axial Position (Micron)');
ylabel('Amplitude (a.u.)');

plot(0:Lateral_Spacing:Lateral_Spacing*(size(Height,2)-1),Height(240,:),0:Lateral_Spacing:Lateral_Spacing*(size(Height,2)-1),CheckCurve(240,:));
