...
data_Bscan=importdata('D:\120111\3mm 1 (not enough range)(the 1.6 one)3.txt');
data_Bscan=data_Bscan(:,501:(round(length_lateral/lateral_step)+500));
...
if ref_sub==1
    ...
    ref_Bscan=ref_Bscan(:,501:(round(length_lateral/lateral_step)+500)); 
