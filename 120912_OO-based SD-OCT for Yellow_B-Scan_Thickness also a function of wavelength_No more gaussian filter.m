...
Sample_Path='C:\TuanShu\120905_YPR Bscan_2\';
Reference_Path='C:\TuanShu\120905_YPR Bscan_2\ref\';
...
Ratio_Upper2Reference=1.1+[-0.2:0.02:0.2];%+[-0.2:0.02:0.2];
...
Current_separation=67.5;
Current_DC_cutoff=57;

DC_cutoff_ref=64;

High_Frequency_cutoff_ref=76;
Window_Size=10;
%%
n_should=1.6;
delta_n=0.2;
...
%% Data Loading
for array_number=50%length(array)
...
%% Spectrum generation
Signal_Sample_Temp=Signal_Sample;
Current_separation_index=find(Position_micron>Current_separation,1,'first');
