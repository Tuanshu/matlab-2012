...
lateral_index_calibration_start=200;
lateral_index_calibration_end=900;

lateral_index_reference_start=650;
lateral_index_reference_end=900;

lateral_index_sample_start=501;
lateral_index_sample_end=501;
