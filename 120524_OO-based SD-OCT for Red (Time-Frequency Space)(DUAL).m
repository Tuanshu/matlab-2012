...
Filter_inter=0;
cd('D:\120524\SAM7_OPD1FOC1\inter\');
for j=0:99
...
Spectrum_Sample=Spectrum_Sample./Spectrum_Reference;
...
Spectrum_Sample=Spectrum_Sample./Gauss_Window;
...
for j=1:length(Spatial_Range)
    ...
    Signal_Sample(round(length(Signal_Sample)/2)+1:end)=0;
    Spectrum_Sample_Part=(ifft(Signal_Sample));
    Time_Spectrum_Sample_2(:,j)=2*Spectrum_Sample_Part(1:N_f);
    
end
imagesc(abs(Time_Spectrum_Sample_2),'xdata',Spatial_Range,'ydata',Frequency);

%% Dual

Time_Spectrum_Sample_Dual=(Time_Spectrum_Sample.*Time_Spectrum_Sample_2).^0.5;
...
imagesc(10*log(abs(Time_Spectrum_Sample(Frequency_min_index:Frequency_max_index,:))),'xdata',Spatial_Range,'ydata',Frequency(Frequency_min_index:Frequency_max_index));
imagesc(10*log(abs(Time_Spectrum_Sample_2(Frequency_min_index:Frequency_max_index,:))),'xdata',Spatial_Range,'ydata',Frequency(Frequency_min_index:Frequency_max_index));
imagesc(10*log(abs(Time_Spectrum_Sample_Dual(Frequency_min_index:Frequency_max_index,:))),'xdata',Spatial_Range,'ydata',Frequency(Frequency_min_index:Frequency_max_index));
