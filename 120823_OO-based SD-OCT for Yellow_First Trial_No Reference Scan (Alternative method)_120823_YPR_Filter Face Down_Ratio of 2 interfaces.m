...
Ratio_Upper2Reference=1;
Position_Upper2Reference=(15.85)*1E-6;
Number_of_Loop=100;
Thickness=(4.21).*1E-6;% ([-0.1:0.1:0.1]+2.55).*1E-6; In this file, it is the initial guess of thickness
Load_Previous_Result=0;
Ratio_Lower2Upper=1.23;  %([-1:0.02:1]+10.82)*1E-6;%[0.019:0.001:0.024]*1E-6;%[0.02:0.0003:0.023]*1E-6;
%%
n_should=1.6;
delta_n=0.4;
