...
Position_Upper_Interface=(18.22).*1E-6;  %([-1:0.02:1]+10.82)*1E-6;%[0.019:0.001:0.024]*1E-6;%[0.02:0.0003:0.023]*1E-6;
%%
n_should=1.7;
delta_n=0.4;
...
dlmwrite('SAM5 n.txt',real(n_Best),'delimiter','\t','newline','pc');
dlmwrite('SAM5 k.txt',imag(n_Best),'delimiter','\t','newline','pc');
dlmwrite('SAM5 T.txt',T_Best,'delimiter','\t','newline','pc');
