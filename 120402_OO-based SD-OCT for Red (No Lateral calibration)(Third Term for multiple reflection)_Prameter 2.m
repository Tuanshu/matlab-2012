...
Ratio2=1;
Number_of_Loop=5;
Thickness=([-1:0.1:1]+2.53).*1E-6;
Load_Previous_Result=0;
Position_Error=-3.49*1E-6;%[0.019:0.001:0.024]*1E-6;%[0.02:0.0003:0.023]*1E-6;
%%
n_should=1.5;
delta_n=0.2;
...
Signal_Sample=fft(Spectrum_Sample).*gaussmf(Position_micron,[Gauss_Window 27.4]);  
...
plot(Wavelength_micron(Frequency_Considered_Min_Index:Frequency_Considered_Max_Index),n_final(Frequency_Considered_Min_Index:Frequency_Considered_Max_Index,5));

xlabel('Wavelength (micron)');
ylabel('n');

%%
plot(Wavelength_micron(Frequency_Considered_Min_Index:Frequency_Considered_Max_Index),k_final(Frequency_Considered_Min_Index:Frequency_Considered_Max_Index,5));

xlabel('Wavelength (micron)');
ylabel('k');
%%
plot(Wavelength_micron(Frequency_Considered_Min_Index:Frequency_Considered_Max_Index),T_abs_check(Frequency_Considered_Min_Index:Frequency_Considered_Max_Index,5));
