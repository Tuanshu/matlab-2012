...
cd('D:\Users\TuanShu\121016_Test1_Eye3\');
...
plot(0:Lateral_Spacing:Lateral_Spacing*(size(Height,2)-1),Height(50,:),0:Lateral_Spacing:Lateral_Spacing*(size(Height,2)-1),CheckCurve(50,:));
xlabel('(Micron)');
ylabel('(Micron)');
