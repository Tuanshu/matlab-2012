...
cd('D:\120716_PD60dB_2.2x2V_SLD full Power_20kHz\');
...
Window1=(gaussmf(Frequency,[0.2E14 Filter_Low]));
Window1(Frequency>Filter_Low)=1;
Window2=(gaussmf(Frequency,[0.2E14 Filter_High]));
