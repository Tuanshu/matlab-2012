...
Position_Error=1.64981117104471*1E-6;%[0.019:0.001:0.024]*1E-6;%[0.02:0.0003:0.023]*1E-6;
n_should=1.5:0.1:1.8;
delta_n=0.1;
Wavelength_Center=560;
...
cd('D:\120110_1mm red color filter_again again\');
...
pixel_1=1100;               % the end of 1
pixel_2=3000;%2000               % the end of 2
pixel_3=1760;               %for saperation
