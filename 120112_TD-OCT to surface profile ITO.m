...
data_Bscan=importdata('D:\120111\ITO.txt');
...
short_pass=3;   %in terms of pixel
...
if ref_sub==1
    ref_Bscan=importdata('D:\120111\ITO_ref.txt');  
...
for jj=1:100
    data_Bscan_env_Shift(:,jj)=circshift(data_Bscan_env(:,jj),-index_ref(jj)+3000);
end

imagesc(10*log10(data_Bscan_env_Shift(end:-1:1,:)),'xdata',lateral_position,'ydata',axial_position);
