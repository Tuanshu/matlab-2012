...
Position_Error=-1.195175706296598*1E-6+0.19*1E-6;%[0.019:0.001:0.024]*1E-6;%[0.02:0.0003:0.023]*1E-6;
DC_phase=-0.1:0.01:0.1;
n_should=1.65;
delta_n=0.1;
...
for q=1:length(DC_phase)
Spectrum_Additional=exp(i*4*pi.*Frequency/C.*(Position_Error)).*exp(i.*DC_phase(q).*2*pi);
