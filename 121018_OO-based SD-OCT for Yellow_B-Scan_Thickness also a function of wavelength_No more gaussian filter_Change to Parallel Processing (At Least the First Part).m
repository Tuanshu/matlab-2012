...
for p=1:length(Max_index)
    if If_Second_Exist(p)==0 %Second non-exist
        ...
        Signal_Sample_1(:,p)=Signal_Sample_First;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        Spectrum_Temp=ifft(Signal_Sample_First(:,p));
        Spectrum_Sample_2(:,p)=2*Spectrum_Temp(1:N_f);

        Spectrum_Temp=ifft(Signal_Sample_Second(:,p));
        Spectrum_Sample_1(:,p)=2*Spectrum_Temp(1:N_f);
