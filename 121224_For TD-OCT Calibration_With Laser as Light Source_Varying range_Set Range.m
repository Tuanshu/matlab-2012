...
for p=1:length(Range)
    Data=importdata(sprintf('121219_f%g_V%d.txt',Frequency(q),Range(p)));                   %Asuume: line 1: time, line 2: interference signal, line 3: voltage 121219_f0.001_V2to8.txt©Ç©Ç

    min_voltage=(10-Range(p))/2;
    max_voltage=min_voltage+Range(p);
...
legend('V_p_p=2V','V_p_p=4V','V_p_p=6V','V_p_p=8V','V_p_p=10V');
