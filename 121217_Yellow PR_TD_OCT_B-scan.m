...
TD_OCT_point_Spacing=0.00884375;      %micron 因為我取的點數是原先的四倍, 故好像應該是169.8/4800/4=0.00884375
...
Sample_Path='D:\Users\TuanShu\121212\Yellow_PR_UpseideDown_Sample\';
Reference_Path='D:\Users\TuanShu\121212\Yellow_PR_UpseideDown_Reference\';
Spectroscopy_Path='D:\Users\TuanShu\';


%% Parameters
Ratio_Upper2Reference=1.3;%+[-0.05:0.005:0.05];
Thickness=(4.699).*1E-6;% ([-0.1:0.1:0.1]+2.55).*1E-6; In this file, it is the initial guess of thickness
n_should=1.599;
Ratio_Lower2Upper=1.3;%+[-0.05:0.005:0.05];%+[-0.2:0.02:0.2];  %([-1:0.02:1]+10.82)*1E-6;%[0.019:0.001:0.024]*1E-6;%[0.02:0.0003:0.023]*1E-6;

%% Data Loading

Considered_Lateral_Index_Range=91:110;
Considered_Axial_Index_Range=7001:13000;
...
cd(Sample_Path);
Signal_Sam=importdata('D0.txt'); 
cd(Reference_Path);
Signal_Ref=importdata('D0.txt');
...
Shift_Amount=fix(Distance_of_Largest_Signal_of_Sample_from_Zero/TD_OCT_point_Spacing)-maxindex(1);  %乾脆直接用第一行來shift, circshift吃1d array好像會怪怪
...
%%
plot(Position_micron(Position_micron<50),Signal_Sam_Filtered(Position_micron<50,11));%,Position_micron,Signal_Ref_Filtered(:,:));
...
plot(Position_micron,Signal_Sample_1(:,1),Position_micron,Signal_Sample_2(:,1));
