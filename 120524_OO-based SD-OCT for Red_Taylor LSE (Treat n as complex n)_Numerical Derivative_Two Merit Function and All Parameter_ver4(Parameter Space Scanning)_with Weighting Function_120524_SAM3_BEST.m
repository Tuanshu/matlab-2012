...
Ratio_Reference2Sample=1.51;
Ratio_Upper2Lower=1.55;
Number_of_Loop=100;
Thickness=(2.53).*1E-6;% ([-0.1:0.1:0.1]+2.55).*1E-6;
Load_Previous_Result=0;
Position_Upper_Interface=(17.61).*1E-6;  %([-1:0.02:1]+10.82)*1E-6;%[0.019:0.001:0.024]*1E-6;%[0.02:0.0003:0.023]*1E-6;
%%
n_should=1.7;
delta_n=0.4;
...
dlmwrite('SAM3 n.txt',real(n_Best),'delimiter','\t','newline','pc');
dlmwrite('SAM3 k.txt',imag(n_Best),'delimiter','\t','newline','pc');
dlmwrite('SAM3 T.txt',T_Best,'delimiter','\t','newline','pc');
